...
export default function DashboardSection({
  ...
  const stableCount = safeComponents.filter(
    (c) => c.status === "stable"
  ).length;
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-base text-[hsl(215,16%,47%)] mt-1 leading-relaxed">
          Overview of your component library
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {stats.map((stat) => (
          <Card
            key={stat.label}
            className="bg-[hsl(0,0%,98%)]/75 backdrop-blur-[16px] border border-white/[0.18] rounded-[0.875rem] shadow-md"
          >
            <CardContent className="pt-5 pb-4 px-5">
              <p className="text-sm font-medium text-[hsl(215,16%,47%)] uppercase tracking-wide">
                {stat.label}
              </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
          <h2 className="text-base font-semibold text-[hsl(222,47%,11%)]">
            Categories
          </h2>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <h3 className="text-base font-semibold text-[hsl(222,47%,11%)]">
                          {cat.name}
                        </h3>
                      ...
                      <p className="text-sm text-[hsl(215,16%,47%)] mt-1 leading-relaxed">
                        {cat.description}
                      </p>
                    </div>
                  </div>
        ...
        <div className="space-y-4">
                ...
                <React.Fragment key={comp.id}>
                  ...
                  >
                    <div className="min-w-0">
                      <p className="text-base font-medium text-[hsl(222,47%,11%)] truncate">
                        {comp.name}
                      </p>
                      <p className="text-sm text-[hsl(215,16%,47%)] truncate">
                        {comp.category}
                      </p>
                    </div>
                    <span
          ...
          <h2 className="text-base font-semibold text-[hsl(222,47%,11%)] pt-2">
            Getting Started
          </h2>
          <Card className="bg-[hsl(0,0%,98%)]/75 backdrop-blur-[16px] border border-white/[0.18] rounded-[0.875rem] shadow-md">
            <CardContent className="pt-5 pb-4 px-5 space-y-3">
              <div className="flex items-start gap-3">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-indigo-100 text-indigo-700 text-sm font-semibold shrink-0">
                  1
                </span>
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-base text-[hsl(215,16%,47%)] leading-relaxed">
                  Preview variants and customize props in the detail view
                </p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-indigo-100 text-indigo-700 text-sm font-semibold shrink-0">
